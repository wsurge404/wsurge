...
import 'package:wsurge/common/confirmation_dialogs.dart';
import 'package:wsurge/core/common/adaptive_icon.dart';
...
import 'package:wsurge/core/profiles/notifier/profile_notifier.dart';
...
import 'package:wsurge/pages/profiles/adaptive_menu.dart';
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color:
                      isMain ? theme.colorScheme.primary : Colors.transparent,
                ),
              ),
            ),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final menuItems = [
      ...
      AdaptiveMenuItem(
        ...
        onTap: () async {
          GoRouter.of(context)
              .goNamed("updateProfile", pathParameters: {"id": profile.id});
        },
      ),
      AdaptiveMenuItem(
