...
import 'package:wsurge/core/config/model/config_option_failure.dart';
...
import 'package:wsurge/core/utils/json_converters.dart';
...
abstract class ConfigOptions {
  ...
  static final singboxConfigOptions = FutureProvider<SingboxConfigOption>(
    (ref) async {
      ...
      var options = await ref.watch(mitmOverviewNotifierProvider.notifier).getAsync();
