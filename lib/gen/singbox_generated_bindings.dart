...
class SingboxNativeLibrary {
  ...
  ffi.Pointer<ffi.Char> changeOptions(
  ...
  late final _changeOptionsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<ffi.Char>)>>('changeOptions');
  late final _changeOptions = _changeOptionsPtr
  ...
  ffi.Pointer<ffi.Char> startRequestLog(
    int port,
  ) {
    return _startRequestLog(
      port,
    );
  }

  late final _startRequestLogPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.LongLong)>>(
          'startRequestLog');
  late final _startRequestLog =
      _startRequestLogPtr.asFunction<ffi.Pointer<ffi.Char> Function(int)>();

  ffi.Pointer<ffi.Char> stopRequestLog() {
    return _stopRequestLog();
  }

  late final _stopRequestLogPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>(
          'stopRequestLog');
  late final _stopRequestLog =
      _stopRequestLogPtr.asFunction<ffi.Pointer<ffi.Char> Function()>();
  ...
  ffi.Pointer<ffi.Char> generateCa(
    ffi.Pointer<ffi.Char> path,
  ) {
    return _generateCa(
      path,
  ...
  late final _generateCaPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>>('generateCa');
  late final _generateCa = _generateCaPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();

  ffi.Pointer<ffi.Char> changeMitmOptions(
    ffi.Pointer<ffi.Char> options,
  ) {
    return _changeMitmOptions(
      options,
    );
  }

  late final _changeMitmOptionsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<ffi.Char>)>>('changeMitmOptions');
  late final _changeMitmOptions = _changeMitmOptionsPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
}
